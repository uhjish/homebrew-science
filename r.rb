...
class R < Formula
  ...
  def install
    ...
    if build.with? "openblas"
      ...
      ENV.append "CPPFLAGS", "-m64 -I/opt/intel/mkl/include"
      ENV.append_to_cflags "-m64 -I/opt/intel/lib/include"
      ENV.append "MKL", "-L/opt/intel/mkl/lib -Wl,-rpath,/opt/intel/mkl/lib -lmkl_rt -lpthread -lm -ldl"
      ENV.append "LDFLAGS", "-L/opt/intel/mkl/lib/intel64"
      ENV.append "LD_LIBRARY_PATH", "/opt/intel/mkl/lib/intel64"
